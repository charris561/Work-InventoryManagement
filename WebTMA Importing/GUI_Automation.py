...
def inventoryAsset(incomingAsset_List):
    ...
    '''
    LOG.defineHeaders()
    GUI.cmdProgressBar(0, len(incomingAsset_List) - 1)

    for currentAssetNum, currentAsset in enumerate(incomingAsset_List):
        ...
        #update progress bar
        GUI.cmdProgressBar(currentAssetNum, len(incomingAsset_List) - 1)
